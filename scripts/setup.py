...
╔═══════════════════════════════════════════════════════════╗
║                                                           ║
║   🎯 Spredd Markets Bot Setup                             ║
║                                                           ║
║   Multi-platform prediction market trading via Telegram   ║
║   Supports: Kalshi • Polymarket • Opinion Labs            ║
║                                                           ║
╚═══════════════════════════════════════════════════════════╝
    """)
...
def main():
    ...
    if env_path.exists():
        overwrite = prompt("⚠️  .env file already exists. Overwrite? (y/N)", default="n")
    ...
    print("   ⚠️  SAVE THIS KEY! Losing it means losing all user wallets!")
    ...
    # RPC URLs
    print("\n" + "=" * 50)
    print("\n🌐 BLOCKCHAIN RPC URLS (press Enter for defaults)\n")
...
"""
    ...
    print("")
    print("⚠️  IMPORTANT: Back up your ENCRYPTION_KEY securely!")
