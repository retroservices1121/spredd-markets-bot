...
const API_BASE =
  (process.env.EXPO_PUBLIC_API_URL ||
    "https://spredd-markets-bot-production.up.railway.app") + "/api/v1";

const TOKEN_KEY = "spredd_token";
const ONBOARDED_KEY = "spredd_onboarded";
...
// Generic request function — all API calls go through here
...
export async function getLeaderboard(
  ...
  try {
    ...
    return {
      entries: [
        { rank: 1, user_id: "1", username: "CryptoKing", pnl: 12450.5, win_rate: 0.78, total_trades: 142 },
        { rank: 2, user_id: "2", username: "MarketWhiz", pnl: 8920.3, win_rate: 0.72, total_trades: 98 },
        { rank: 3, user_id: "3", username: "PredictionPro", pnl: 6780.0, win_rate: 0.69, total_trades: 205 },
        { rank: 4, user_id: "4", username: "AlphaTrader", pnl: 5430.25, win_rate: 0.65, total_trades: 87 },
        { rank: 5, user_id: "5", username: "BetMaster", pnl: 4210.8, win_rate: 0.71, total_trades: 156 },
        { rank: 6, user_id: "6", username: "OracleX", pnl: 3890.15, win_rate: 0.62, total_trades: 134 },
        { rank: 7, user_id: "7", username: "Forecaster", pnl: 3120.4, win_rate: 0.68, total_trades: 76 },
        { rank: 8, user_id: "8", username: "EdgeSeeker", pnl: 2450.9, win_rate: 0.59, total_trades: 112 },
        { rank: 9, user_id: "9", username: "SharpBet", pnl: 1980.6, win_rate: 0.64, total_trades: 95 },
        { rank: 10, user_id: "10", username: "DeltaHunter", pnl: 1540.2, win_rate: 0.57, total_trades: 188 },
      ],
    };
  }
}
...
export async function getFollowing(): Promise<{
  users: Array<{ user_id: string; username: string; avatar?: string }>;
}> {
  try {
